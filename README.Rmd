...
* Variables
  + **player_salary**  
      ...
      *age*              : age     
      *total_value*      : the predicted value provided by a player based on his performance
      *ave_year*         : yearly averaged salary  
      *total_guaranteed* : a new contract for the player is initially reported with    
