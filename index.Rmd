...
write.csv(coach_salary, file= "coach_salary_slide.csv")
write.csv(coach_record, file= "coach_record_slide.csv")
write.csv(player_salary, file= "player_salary_slide.csv")
...
## NanNan 1(Please lable them in sections)
