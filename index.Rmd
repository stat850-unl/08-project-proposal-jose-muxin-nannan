...
corAge <- ggplot(data=football_salaries,aes(x=age,y=total_value))+xlim(0, 70)+geom_point(color ="darkgreen")
corAge
```
...
corValue <- ggplot(data=football_salaries,aes(x=total_value,y=fully_guaranteed))+
